...
<div class="col-md-9">
    ...
    <div class="clearfix filters-container">
      <h3 style="text-align: center; color: green;">Search result</h3><br>
        <div class="row">
            ...
            <div class="tab-pane active" id="list-container">
                <div class="category-product">
                    <div class="category-product-inner wow fadeInUp animated" style="visibility: visible; animation-name: fadeInUp;">
                        <div class="products">
                <?php if ($search_product_details->count()<=0) { ?>
                   <h1 style="width: 70%; color: red; text-align: center;">We can not find this category related products!!</h1>
                <?php } ?>
                @foreach($search_product_details as $all_products)
                            <div class="product-list product">
                                <div class="row product-list-row">
                                    <div class="col col-sm-4 col-lg-4">
                                        <div class="product-image">
                                            <div class="image"><img src="{{ asset($all_products->image1) }}" alt=""></div>
                                        </div>
                                        <!-- /.product-image -->
                                    </div>
                                    <!-- /.col -->
                                    <div class="col col-sm-8 col-lg-8">
                                        <div class="product-info">
                                            <h3 class="name">
                                                <a href="">{{ $all_products->product_name }}</a>
                                            </h3>
                                            ...
                                            <div class="description m-t-10">
                                              {{ Str::limit($all_products->description, 150) }}
                                            </div>
