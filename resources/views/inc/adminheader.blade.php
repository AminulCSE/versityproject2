...
<head>
    ...
    <meta name="description" content="আপনাদের অভিরুচি আমাদের প্রচেষ্ঠায়। নাগরিক চাহিদা নিয়ে 'নগরধারা'">
    <meta name="keywords" content="নগরধারা">
    <meta name="author" content="নগরধারা">
    <!-- Favicon icon -->
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('public/backend/assets\pages\data-table\extensions\responsive\css\responsive.dataTables.css') }}">
    ...
    <!-- Icons/Glyphs -->
    <link rel="stylesheet" href="{{ asset('public/backend/assets\icon\themify-icons\themify-icons.css') }}">
</head>
            ...
            <div class="showChat_inner">
                ...
                <div class="media chat-messages">
                    ...
                    <div class="media-right photo-table">
                        <a href="#!">
                            <img class="media-object img-radius img-radius m-t-5" src="{{ asset('public/backend/assets\images\avatar-4.jpg') }}" alt="Generic placeholder image">
                        </a>
                    </div>
                </div>
