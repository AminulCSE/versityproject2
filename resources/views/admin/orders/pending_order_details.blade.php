                            ...
                            @endif
                                        ...
                                        <div class="row invoive-info">
                                            <div class="col-md-4 col-xs-12 invoice-client-info">
                                                ...
                                                <h6 class="m-0">Name: {{ $get_order->name }}</h6>
                                                <p class="m-0">Email: {{ $get_order->email }}</p>
                                                <p class="m-0">Mobile: {{ $get_order->mobile }}</p>
                                            </div>
                                                ...
                                                <table class="table table-responsive invoice-table invoice-order table-borderless">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {{ $get_order->payment_method }}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <th>Transaction no :</th>
                                                            <td>
                                                                {{ $get_order->transaction_no }}
                                                            </td>
                                                        </tr>
                                                    </tbody>
                                                </table>
                        ...
                        <!-- Approved or not approved status -->
                                            ...
                                            <div class="col-sm-12">
                                                <div class="table-responsive">
                                                    <table class="table  invoice-detail-table">
                                                        ...
                                                        <tbody>
                                                            @php $total=0; @endphp
                                                        @foreach($get_order_details as $details_row)
                                                            <tr>
                                                                <td>
                                ...
                                <div class="row text-center">
                                    <div class="col-sm-12 invoice-btn-group text-center">
                                        @if($get_order->status == 0)
                                        <a href="{{ url('orders/approved_orders_status/'.$get_order->order_no) }}" class="btn btn-success waves-effect m-b-10 btn-sm waves-light">Do Approve status</a>
                                        @else
                                        <a href="{{ url('orders/unapproved_orders/'.$get_order->order_no) }}" class="btn btn-danger waves-effect m-b-10 btn-sm waves-light">Do UnApprove status</a>
                                        @endif
