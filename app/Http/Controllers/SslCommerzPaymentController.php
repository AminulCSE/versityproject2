...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request){
        ...
        $post_data['verify_code'] = $verify_code;
        $post_data['cus_add2'] = "";
        $post_data['cus_city'] = "";
        ...
        // $to_email = $cus_email;
        $to_email = $post_data['cus_email'];
        $to_name  = $post_data['cus_name'];

        $data = array('name' => 'নগরধারা', 'verify_code'=>$verify_code, 'body'=>'ভেরিফাই কোড ইনপুট বক্সে দিয়ে ফেরিফািই করুন');


        Mail::send('thispage', $data, function($message)use($to_name, $to_email){
            $message->to($to_email)
            ->subject('ভেরিফাই কোড ইনপুট বক্সে দিন');
        });
        ...
        $update_product = DB::table('orders')
            ...
            ->updateOrInsert([
                ...
                'status' => 'Pending',
                'address' => $post_data['cus_add1'].", শহর ".$post_data['cus_state'].", জিপ কোড ".$post_data['cus_postcode'],
        ...
        $contents = Cart::content();
            foreach ($contents as $content) {
                ...
                $order_details->order_id = $get_order_id->id;
